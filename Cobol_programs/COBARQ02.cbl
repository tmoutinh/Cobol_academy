      ...
      *                                                                 00080000
       ...
       01 REG-CLIENTES.                                                 00085201
          05 REG-AGENCIA          PIC 9(04).                            00085302
          05 REG-CONTA            PIC 9(05).                            00085402
          05 REG-NOME             PIC X(30).                            00085502
          05 REG-SALDO            PIC 9(06)V99.                         00085602
      ...
      ****************************************************              00086100
       ...
       0001-PRINCIPAL                            SECTION.               00086400
           ...
           IF WRK-FS-CLIENTES EQUAL "00"                                00088000
             PERFORM 0200-PROCESSAR                                     00089002
             PERFORM 0300-FINALIZAR                                     00090002
           ELSE                                                         00100000
             DISPLAY "JUMP OFF"                                         00101002
           END-IF.                                                      00102000
           STOP RUN.                                                    00103000
       0001-FIM-PRINCIPAL.    EXIT.                                     00104002
      **************************************************                00105000
       0100-INICIALIZAR                          SECTION.               00106000
           OPEN INPUT CLS.                                              00107000
           IF WRK-FS-CLIENTES EQUAL "00"                                00107100
             DISPLAY "ARQUIVO ABERTO"                                   00107202
           ELSE                                                         00107300
             DISPLAY "ERRO NA ABERTURA - STATUS " WRK-FS-CLIENTES       00107402
           END-IF.                                                      00107500
      ...
      **************************************************                00107700
       0200-PROCESSAR                            SECTION.               00107800
           ...
           IF WRK-FS-CLIENTES EQUAL TO "00"                             00108101
             DISPLAY "AGENCIA : " REG-AGENCIA                           00108202
             DISPLAY "CONTA   : " REG-CONTA                             00108302
             DISPLAY "NOME    : " REG-NOME                              00108402
             DISPLAY "SALDO   : " WRK-SALDO-IDE                         00108502
           ELSE                                                         00108601
             DISPLAY "IMPOSSIVEL DE LER"                                00108702
           END-IF.                                                      00108801
      ...
      **************************************************                00109001
       0300-FINALIZAR                            SECTION.               00109101
           ...
           IF WRK-FS-CLIENTES EQUAL "00"                                00120000
             DISPLAY "ARQUIVO FECHADO"                                  00130002
           ELSE                                                         00140000
             DISPLAY "ERRO NO FECHAMENTO - STATUS " WRK-FS-CLIENTES     00150002
           END-IF.                                                      00160000

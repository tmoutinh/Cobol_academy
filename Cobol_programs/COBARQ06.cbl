      ...
      *                                                                 00080001
       ...
       01 WRK-MSG.                                                      00086901
          ...
          05 WRK-MSG-ESCRITA      PIC X(30) VALUE "ERRO NA ESCRITA".    00087203
                                                                        00087301
      ...
      **************************************************                00089201
       0100-INICIALIZAR                          SECTION.               00089301
           ...
           IF WRK-FS-ARQSAI NOT EQUAL "00"                              00089501
             MOVE "0100-INICIALIZAR" TO WRK-ERRO-SECAO                  00089604
             MOVE WRK-MSG-ABERTURA   TO WRK-ERRO-TEXTO                  00089704
             MOVE WRK-FS-ARQSAI      TO WRK-ERRO-STATUS                 00089804
             PERFORM 9000-ERROR                                         00089904
             STOP RUN                                                   00090004
           END-IF.                                                      00104001
       0100-INICIALIZAR-FIM.  EXIT.                                     00105001
      **************************************************                00106001
       0200-PROCESSAR                            SECTION.               00106101
           MOVE "00205"              TO WRK-REG-ID.                     00106204
           MOVE "TIAGO TEIXEIRA"     TO WRK-REG-NOME.                   00106304
           WRITE REG-ARQSAI          FROM WRK-REG-ARQSAI.               00106404
           IF WRK-FS-ARQSAI NOT EQUAL "00"                              00106501
             MOVE "0200-PROCESSAR"   TO WRK-ERRO-SECAO                  00106604
             MOVE WRK-MSG-ESCRITA    TO WRK-ERRO-TEXTO                  00106704
             MOVE WRK-FS-ARQSAI      TO WRK-ERRO-STATUS                 00106804
             PERFORM 9000-ERROR                                         00106904
           END-IF.                                                      00107001
      ...
      **************************************************                00109201
       0300-FINALIZAR                            SECTION.               00109301
           ...
           IF WRK-FS-ARQSAI NOT EQUAL "00"                              00109501
             MOVE "0300-FINALIZAR"   TO WRK-ERRO-SECAO                  00109604
             MOVE WRK-MSG-FECHO      TO WRK-ERRO-TEXTO                  00109704
             MOVE WRK-FS-ARQSAI      TO WRK-ERRO-STATUS                 00109804

      ...
      *            REGRAVACAO DE 1 REGISTO                              00051000
      ...
      **************************************************                00089000
       0200-PROCESSAR                            SECTION.               00090000
           ...
           MOVE   WRK-REG-ARQCLI       TO   REG-ARQCLI.                 00101000
           READ AQL.                                                    00101100
           IF WRK-FS-ARQCLI EQUAL "00"                                  00101200
             REWRITE REG-ARQCLI FROM WRK-REG-ARQCLI                     00102000
           ELSE                                                         00103000
             DISPLAY "NAO EXISTE CHAVE " WRK-ARQCLI-CHAVE               00104000
             MOVE "DID NOT WRITE" TO WRK-STATUS                         00105000
           END-IF.                                                      00106100
